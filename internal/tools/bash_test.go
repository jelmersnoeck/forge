...
func TestCheckInteractiveCommand(t *testing.T) {
	tests := map[string]struct {
		...
		"git rebase":               {command: "git rebase main", isValid: true},
		"git rebase interactive":   {command: "git rebase -i main", isValid: false},
		"git rebase --interactive": {command: "git rebase --interactive HEAD~3", isValid: false},
		"git add":                  {command: "git add file.txt", isValid: true},
		"git add --all":            {command: "git add --all", isValid: true},
		"git add -i":               {command: "git add -i", isValid: false},
		"git add --interactive":    {command: "git add --interactive file.txt", isValid: false},
		"git add -p":               {command: "git add -p file.txt", isValid: false},
		"git add --patch":          {command: "git add --patch", isValid: false},
		"git reset":                {command: "git reset HEAD file.txt", isValid: true},
		"git reset --hard":         {command: "git reset --hard HEAD~1", isValid: true},
		"git reset -p":             {command: "git reset -p", isValid: false},
		"git reset --patch":        {command: "git reset --patch HEAD", isValid: false},
